...
import { SukunPlaces, FivePlaces } from '../CardContents';
import {
...
function Sukun() {
  return (
    <>
      ...
      <p className="text-center my-5" style={browseTitle}>There Are 3 Places in Sukun</p>
      {SukunPlaces.map((cardData, id) => (
